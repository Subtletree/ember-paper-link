import PaperLink from 'ember-paper-link/components/paper-link';
import { getOwner } from '@ember/application';
import { set, get } from '@ember/object';
import { typeOf } from '@ember/utils';
import { assert } from '@ember/debug';

// https://github.com/ember-engines/ember-engines/blob/master/addon/components/link-to-component.js
export default PaperLink.extend({
  didReceiveAttrs() {
